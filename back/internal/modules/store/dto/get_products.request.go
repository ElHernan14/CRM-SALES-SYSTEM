...
type GetStoreProductsRequest struct {
	...
	Category   string  `json:"category" validate:"omitempty,min=2,max=80" example:"electronics"`
	...
	SortColumn string `json:"sort_column" validate:"omitempty,max=50,oneof=name created_at type category price stock" example:"price"`
