...
func SetupRoutes(r *mux.Router, db *sql.DB, cfg config.Config) {
	...
	marketplace.RegisterMarketplaceRoutes(r, container.MarketplaceController)
	...
	marketplace.RegisterMarketplaceProtectedRoutes(protected, container.MarketplaceController)
